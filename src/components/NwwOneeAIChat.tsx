          ...
          <div className="bg-blue-600/20 border-divider-b relative flex rounded-t-2xl rounded-b-3xl min-h-[140px] overflow-hidden">
            ...
            <div className="pl-[135px] py-5 pr-5 flex flex-col justify-center">
              ...
              <p className="text-[11px] text-fill-color/70 leading-5 relative z-20">
                Your Nww Ecosystem AI assistant. Helping you find recommended communities, explain community details, and summarize data.
              </p>
            </div>
          </div>
            ...
            {messages.length === 0 ? (
              <div className="p-5">
                ...
                <div className="flex flex-col gap-2.5">
                  <button onClick={() => handleSend("Find recommended communities")} className="relative text-left px-4 py-3 rounded-xl bg-gradient-to-r from-blue-600/10 to-blue-500/10 hover:from-blue-600/20 hover:to-blue-500/20 transition-all text-sm text-fill-color/90 hover:text-fill-color shadow-sm cursor-pointer group">
                    <div 
                    ...
                    ></div>
                    <span className="relative z-10">Find recommended communities</span>
                  </button>
                  <button onClick={() => handleSend("Explain community details")} className="relative text-left px-4 py-3 rounded-xl bg-gradient-to-r from-blue-600/10 to-blue-500/10 hover:from-blue-600/20 hover:to-blue-500/20 transition-all text-sm text-fill-color/90 hover:text-fill-color shadow-sm cursor-pointer group">
                    <div 
                      className="absolute inset-0 rounded-xl border border-transparent bg-gradient-to-r from-blue-600 to-blue-500 pointer-events-none" 
                      style={{ 
                        WebkitMask: 'linear-gradient(#fff 0 0) padding-box, linear-gradient(#fff 0 0)', 
                    ...
                    ></div>
                    <span className="relative z-10">Explain community details</span>
                  </button>
